...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Realation</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-iditem">
                                        ...
                                        <td class="value"> <?php echo $data['iditem']; ?></td>
                                    </tr>
                                    <tr  class="td-tglpembelian">
                                        <th class="title"> Tglpembelian: </th>
                                        <td class="value"> <?php echo $data['tglpembelian']; ?></td>
                                    </tr>
                                    <tr  class="td-jumlahitem">
                                        <th class="title"> Jumlahitem: </th>
                                        <td class="value"> <?php echo $data['jumlahitem']; ?></td>
                                    </tr>
                                    <tr  class="td-totalpembelian">
                                        <th class="title"> Totalpembelian: </th>
                                        <td class="value"> <?php echo $data['totalpembelian']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
