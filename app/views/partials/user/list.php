...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    if( $show_header == true ){
    ?>
    <div  class="bg-light p-0 mb-3 ">
        <div class="container-fluid">
            <div class="row ">
                <div class="col-sm-12 p-2  bs ">
                    <h3 class="record-title"><div style= "color :white;"> User
                    </div></h3>
                </div>
                <div class="col-sm-6 p-2 kiri ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-success my-1 hadap" href="<?php print_link("user/add") ?>">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-idpembeli"><a href="<?php print_link("user/view/$data[idpembeli]") ?>"><?php echo $data['idpembeli']; ?></a></td>
                                                    <td class="td-username">
                                                        <span  data-value="<?php echo $data['username']; ?>" 
                                                            data-pk="<?php echo $data['idpembeli'] ?>" 
                                                            data-url="<?php print_link("user/editfield/" . urlencode($data['idpembeli'])); ?>" 
                                                            data-name="username" 
