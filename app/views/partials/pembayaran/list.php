...
$can_add = ACL::is_allowed("pembayaran/add");
$can_edit = ACL::is_allowed("pembayaran/edit");
$can_view = ACL::is_allowed("pembayaran/view");
$can_delete = ACL::is_allowed("pembayaran/delete");
?>
<?php
