...
class TransaksiController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				transaksi.idpembelian LIKE ? OR 
				transaksi.idpembayaran LIKE ? OR 
				transaksi.iduser LIKE ? OR 
				transaksi.iditem LIKE ? OR 
				transaksi.tglpembelian LIKE ? OR 
				transaksi.jumlah LIKE ?
			)";
			$search_params = array(
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("transaksi.idpembelian", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("transaksi.idpembelian", $rec_id);; //select record based on primary key
		}
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("transaksi.idpembelian", $rec_id);;
	...
	function delete($rec_id = null){
		...
		$db->where("transaksi.idpembelian", $arr_rec_id, "in");
