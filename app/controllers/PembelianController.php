...
class PembelianController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				pembelian.idpembelian LIKE ? OR 
				pembelian.idpembayaran LIKE ? OR 
				pembelian.iduser LIKE ? OR 
				pembelian.iditem LIKE ? OR 
				pembelian.tglpembelian LIKE ? OR 
				pembelian.jumlah LIKE ?
			)";
			$search_params = array(
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("pembelian.idpembelian", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("pembelian.idpembelian", $rec_id);; //select record based on primary key
		}
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("pembelian.idpembelian", $rec_id);;
	...
	function delete($rec_id = null){
		...
		$db->where("pembelian.idpembelian", $arr_rec_id, "in");
