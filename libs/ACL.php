...
class ACL
{
	...
	public static $role_pages = array(
			'user' =>
						array(
							'product' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'game' => array('list','view','add','edit', 'editfield','delete','sm_list','import_data'),
							'grid' => array('list','view','sm_list1'),
							'pembayaran' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'pemesanan2' => array('list','view','add','edit', 'editfield','delete')
						),
			...
			'admin' =>
						array(
							...
							'grid' => array('list','view','sm_list1'),
							'pembayaran' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'pemesanan2' => array('list','view','add','edit', 'editfield','delete','import_data')
						),
